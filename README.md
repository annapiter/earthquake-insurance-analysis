...
│   ├── 03_fault_lines_integration.ipynb
...
* ✅ **Phase 3** – [Fault line features added: intersections, distance, length, azimuth](https://github.com/annapiter/earthquake-insurance-analysis/blob/main/notebooks/03_fault_lines_integration.ipynb)
...
The following seismic features were engineered using spatial joins and geometric calculations:
...
| `fault_length_km`        | Total length of fault line segments within county boundary (km)   |
| `mean_fault_azimuth_deg` | Average orientation angle (azimuth) of faults within each county  |
| `fault_orientation`      | Categorized direction (e.g. N–S, NE–SW, E–W, NW–SE, or No Faults) |

✅ These variables enrich the dataset with detailed **spatial exposure metrics**, enabling more accurate modeling of earthquake insurance risk.
...
> Launch exploratory data analysis on fault exposure and insurance coverage.
> Define derived variables (e.g. `underinsured_risk_score`) and begin predictive modeling.
